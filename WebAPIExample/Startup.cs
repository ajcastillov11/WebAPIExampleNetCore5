...
namespace WebAPIExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(cfg => cfg.AddPolicy("CanAccessProducts", p => p.RequireClaim("CanAccessProducts", "true")));
            //********************************
        ...
        public JwtSettings GetJwtSettings()
        {
            return new JwtSettings()
            {
                ...
                minutesToExpiration = Convert.ToInt32(Configuration["Jwt:minutesToExpiration"])
            };
